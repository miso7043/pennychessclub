...
const pccOpen4Data: TournamentEventDataType = {
  hero: {
    title: "Penny Chess Club Open 4",
  ...
  events: [
    {
      ...
      schedule: {
        summary: "04/27/2025 (Sunday) 4 Rounds G15+10",
        rounds: [
          "R1-2:00 PM G/15+10",
          "R2-3:00 PM G/15+10",
          "R3-4:00 PM G/15+10",
  ...
  deadlines: {
    deadlines: [
      { label: "Registration Deadline", deadline: "Before 1:00 PM April 26, 2025 or max 40 players" },
    ],
...
export default function PCCOpen4() {
  return <TournamentEvent data={pccOpen4Data} backImgPath="/imgs/bg/parallax-back-4.webp" />;
}
