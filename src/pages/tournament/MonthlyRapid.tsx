...
// ---------- PAGE DATA ----------
const monthlyRapidData: TournamentEventDataType = {
  hero: {
  ...
  playUp: {
    ...
    policy: [
      ...
      "In this case you need to add a play up fee of $10, in addition to the entry fee, at checkout.",
...
export default function MonthlyRapid() {
  return <TournamentEvent data={monthlyRapidData} backImgPath="/imgs/bg/parallax-back-3.webp" />;
}
